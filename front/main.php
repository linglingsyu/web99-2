...
<div class="container">
  ...
  <div class="post active" id="p1"><h2>健康新知</h2><pre>缺乏運動已成為影響全球死亡率的第四大危險因子-國人無規律運動之比率高達72.2%
    資料來源： 行政院衛生署國民健康局 
    發佈日期： 2012 / 10 / 07
    ...
    7. 減少看電視、打電玩等靜態生活的時間。
        民眾對運動如有疑問，可參考國民健康局肥胖防治網-「快樂動」(http://obesity.bhp.gov.tw)，亦可撥打免費市話健康體重管理電話諮詢服務，諮詢專線「0800-367-100（0800-瘦落去-要動動）」，也可利用國民健康局局網首頁或肥胖防治網問題諮詢專區的網路電話撥入功能，向客服人員諮詢關於運動、健康飲食及健康體重管理等相關疑問。</pre></div>
  <div class="post" id="p2"><h2>菸害防治</h2><pre>菸害防治法規
  ...
  <div class="post" id="p3"><h2>癌症防治</h2><pre>降低罹癌風險 建構健康生活型態
  ...
  <div class="post" id="p4"><h2>慢性病防治</h2><pre>長期憋尿 泌尿系統問題多 
    資料來源：中央健康保險局雙月刊第98期
    上稿日期：2012/08/10
    文／游小雯
    ...
    如果民眾發現自己解尿不舒服時，一定要在第一時間就診，讓醫師採用檢體對症下藥，只要沒有其他的特殊問題併存，同時能接受完整療程的抗生素治療，通常一星期左右即可痊癒。不過服藥的時間及用量絕對要遵照醫師囑咐，如果自行隨意停藥或不按時服用，很可能會造成殘存的細菌出現抗藥性，非但原本的症狀無法痊癒，還可能帶來慢性泌尿道發炎、尿路結石、腎臟功能受損等併發症，千萬要特別注意。</pre></div>
</div>
